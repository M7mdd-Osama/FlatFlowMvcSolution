    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartmentGroupPosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApartmentGroupPosts_Apartments_ApartmentId",
                        column: x => x.ApartmentId,
                        principalTable: "Apartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApartmentGroupPosts_FacebookGroups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApartmentGroupPosts_ApartmentId",
                table: "ApartmentGroupPosts",
                column: "ApartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ApartmentGroupPosts_GroupId",
                table: "ApartmentGroupPosts",
                column: "GroupId");
